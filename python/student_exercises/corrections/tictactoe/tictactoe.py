...
def draw_board(board: list[str]) -> None:
    ...
    # Draw the board. PRO TIP: look at the example `tictactoe.310.py`
#     print(f"""Tic-Tac-Toe
...
def check_win(board: list[str], player: str) -> bool:
    ...
    """
    # if (
    #     board[0] == board[1] and board[1] == board[2] and board[2] == player
    #     or board[3] == board[4] and board[4] == board[5] and board[5] == player 
    #     or board[6] == board[7] and board[7] == board[8] and board[8] == player 

    #     or board[0] == board[3] and board[3] == board[6] and board[6] == player 
    #     or board[1] == board[4] and board[4] == board[7] and board[7] == player 
    #     or board[2] == board[5] and board[5] == board[8] and board[8] == player 

    #     or board[0] == board[4] and board[4] == board[8] and board[8] == player 
    #     or board[2] == board[4] and board[4] == board[6] and board[6] == player 
    # ):
    #     return True
    # else: 
    #     return False
    ...
    for c0, c1, c2 in combos:
        if board[c0] == board[c1] == board[c2] == player:
            return True
    return False
