...
class MegaFood(Food):
    ...
    def draw(self) -> None:
        pygame.draw.rect(screen, (255, 0, 255), (self.position.x, self.position.y, BLOCK_SIZE, BLOCK_SIZE)) 
...
class Snake:
    ...
    ********************************************************************************************************************
    ...
    def __init__(self, color: tuple[int]=GREEN) -> None:
        """
    ...
    def change_direction(self, direction: str) -> None:
        ...
        """
        # if ( self._current_direction == "RIGHT" and direction == "LEFT"
    ...
    def draw(self) -> None:
        # pygame.draw.rect(screen, BLUE, (self.body[0].x, self.body[0].y, BLOCK_SIZE, BLOCK_SIZE))
...
foods = [random.choice([Food(snake), MegaFood(snake)]) for _ in range(10)]
...
def snake_game():
  ...
  while running:
      ...
      for food in foods:
        if (snake.check_collision(food) or snake2.check_collision(food)):
          snake.grow()
          snake2.grow()
          food.create_new_food_item(snake)
          score += 1
          if type(food) == MegaFood:
            score += 1
