...
class Food:
    ...
    def __init__(self, snake) -> None:
        ...
        """
        # Initialize the position of the food with a random position.
    ...
    def create_new_food_item(self, snake) -> None:
        ...
        """
        # Set the position of the food object to a random position that is not on the snake.
        self.position = self.choose_position(snake)

    def draw(self) -> None:
        pygame.draw.rect(
            screen, RED, (self.position.x, self.position.y, BLOCK_SIZE, BLOCK_SIZE)
        )
    ...
    ********************************************************************************************************************
    ...
    def move(self) -> None:
        ...
        ****************************************************************************************************************
        ...
        """
        # don't change this line, it's used to copy the head of the snake.
        new_head: Point = self.body[0].copy()
    ...
    def change_direction(self, direction: str) -> None:
        ...
        """
        # if (
        #     (self.__current_direction == "UP" and direction == "DOWN")
        #     or (self.__current_direction == "DOWN" and direction == "UP")
        #     or (self.__current_direction == "LEFT" and direction == "RIGHT")
        #     or (self.__current_direction == "RIGHT" and direction == "LEFT")
        # ):
        #     return
        ...
        if invalids[self.__current_direction] == direction:
            return
    ...
    def draw(self) -> None:
        for segment in self.body:
            pygame.draw.rect(
                screen, self.color, (segment.x, segment.y, BLOCK_SIZE, BLOCK_SIZE)
            )
    ...
    while running:
        ...
        for food in foods:
            if snake.check_collision(food):
                ...
                score += 1
            elif snake2.check_collision(food):
                snake2.grow()
                food.create_new_food_item(snake)
                score += 1
