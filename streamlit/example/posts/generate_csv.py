...
users: list[dict[str, str]] = [
    {"name": "Marianne", "last_name": "ARINO"},
    {"name": "Martin", "last_name": "ASHTON-LOMAX"},
    {"name": "Claudio", "last_name": "CARDOSO PEREIRA"},
    {"name": "Benoit", "last_name": "D'EPAGNIER"},
    {"name": "Thibault Franck", "last_name": "GRANIER"},
    {"name": "Pietro", "last_name": "GRILLI"},
    {"name": "Ahmad Jawad", "last_name": "MONES"},
    {"name": "Samir", "last_name": "TAHIR"},
    {"name": "Nathalie", "last_name": "VUICHARD"},
]
