...
def register():
    ...
    return render_template("login/register.html", form=form, link_name="register")
...
def login():
    if request.method == "POST":
        ...
        return render_template("login/login.html", link_name="login")
