from wtforms import Form, PasswordField, StringField, RadioField, ValidationError, FileField
...
class RegisterForm(Form):
  ...
  profile_picture = FileField("Profile picture", validators=[DataRequired(), InputRequired()], render_kw={"accept": "image/png, image/jpeg, image/jpg"})
