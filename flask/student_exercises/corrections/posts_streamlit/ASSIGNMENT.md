...
Your instructor has provided a Docker image demonstrating the expected result. To run it:

```bash
docker compose up
```

Then open http://localhost:8501 in your browser to see the working application.