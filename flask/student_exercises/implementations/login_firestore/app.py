...
def register():
  ...
  if request.method == "POST":
    ...
    # TODO: BONUS: before inserting new user check if eamil already exists in database
    # with open(CSV_FILE_PATH, "r") as csv_file:
    ...
    # TODO: Inserrt user in database using `add()` function
    # - create a user dictionnary data
    # - call `add()` function with the user dictionnary on `users` collection
