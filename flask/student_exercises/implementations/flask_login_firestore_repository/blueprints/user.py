...
# TODO: remove csv database and add user repository object
from database.csv_database import get_user_by_username
...
def userinfo():
    ...
    user: User = get_user_by_username(session["uid"])
...
def api_userinfo():
    # TODO: Adapt using the user repository
    user: User = get_user_by_username("moiap13")
    assert user is not None
