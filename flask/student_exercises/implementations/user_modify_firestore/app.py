...
from repositories.users_repository_firestore import get_user_by_email, get_user_by_uid, add_user, get_user_by_firestore_id
...
# TODO: This route should be private (not public, meaning secured by authentication)
