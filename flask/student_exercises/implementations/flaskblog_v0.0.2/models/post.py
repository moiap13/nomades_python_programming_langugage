class Post():
  def __init__(self, title: str, body: str, author: str, summary: str = "", firestore_id: str = "", created_at: str = "", updated_at: str = ""):
    self.firestore_id = firestore_id
    self.title = title
    self.body = body
    self.summary = summary
    self.author = author # TODO: self.author store a User object
