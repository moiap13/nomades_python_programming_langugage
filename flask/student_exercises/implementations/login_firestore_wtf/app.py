...
from forms.login import LoginForm # TODO: import the RegisterForm class
...
def login():
  ...
  if request.method == "POST" and form.validate():
    ...
    # TODO: create a query to select the user with the email provided
...
def register():
  # TODO: create form variable that implement RegisterForm object (look at Login implementation)
  ...
  if request.method == "POST":
    ...
    # TODO: Same as login, don't loop throught the whole database
  ...
  return render_template("login/register.html") # TODO: pass the form variable to the template
