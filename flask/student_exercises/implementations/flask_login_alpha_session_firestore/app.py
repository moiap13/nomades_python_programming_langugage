...
# from repositories.users_repository_csv import get_user_by_uid, add_user
from repositories.users_repository_firestore import get_user_by_uid, add_user
...
def register_post():
    ...
    # TODO: adapt the function call (think about db varaible)
