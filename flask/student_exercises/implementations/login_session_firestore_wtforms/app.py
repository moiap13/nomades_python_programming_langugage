...
def register():
    ...
    """
    # TODO: WTForms: Adapt to use WTForms instead of request.form
    if request.method == "POST": # TODO: WTForms: validate the from
        # 1. Get the data
        # TODO: WTForms: get the data from the wtf form object
        ...
        # GET
        return render_template("login_wtf/register.html") # TODO: WTForms: pass the form object to the front
...
def login():
    ...
    if request.method == "POST": # TODO: WTForms: validate the from
        ...
        return render_template("login_wtf/login.html") # TODO: WTForms: pass the form object to the front
